...
class CustomerTermsPrivacyPolicy extends StatelessWidget {
  const CustomerTermsPrivacyPolicy({Key? key}) : super(key: key);

  final String termsText = '''
**Terms and Conditions**

Welcome to TaskLink. By accessing or using our platform, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.

1. **Acceptance of Terms**  
By using TaskLink, you acknowledge that you have read, understood, and agree to be legally bound by these Terms and Conditions.

2. **Use of Service**  
You agree to use TaskLink solely for lawful purposes and in accordance with all applicable laws and regulations. Unauthorized use is strictly prohibited.
...
TaskLink reserves the right to modify, suspend, or discontinue any aspect of the service at any time without prior notice.

5. **Limitation of Liability**  
TaskLink shall not be liable for any direct, indirect, incidental, or consequential damages arising from your use or inability to use the service.

6. **Governing Law**  
These terms shall be governed by and construed in accordance with the laws of the jurisdiction in which TaskLink operates.
...
If you have questions about our policies, please contact us at privacy@tasklink.com.
