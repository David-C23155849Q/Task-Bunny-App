...
import 'client_terms_and_privacy_policy_page.dart';
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              showAboutDialog(
                context: context,
                applicationName: "TaskBunny",
                applicationVersion: "1.0.0",
                children: [
                  const Text("Built with Flutter.\nContact: dev@taskbunny.com"),
                ],
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const TermsPrivacyPolicyPage()),
              );
            },
          ),
          ...
          ListTile(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const ClientHowItWorksPage()),
            ),
          ),
